...
Public Class Stock
    ...
    Sub CargarList(ByVal dato As String)
        ...
        Try
            ...
            Comando.CommandText = "select descripcion, codigo_producto from producto where descripcion like'" & dato.ToString & "%' OR codigo_producto like'" & dato.ToString & "%' order by descripcion;"
