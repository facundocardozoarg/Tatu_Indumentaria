    ...
    Sub CargarList(ByVal dato As String)
        ...
        Try
            ...
            ElseIf (dato <> "") Then
                ...
                Comando.CommandText = "select codigo_producto, descripcion from producto where codigo_producto like'" & dato.ToString & "%' OR descripcion like'" & dato.ToString & "%' order by codigo_producto;"
