...
Public Class ABMProveedores
    ...
    Sub CargarList(ByVal dato As String)
        Try
            ...
            ElseIf dato <> "" And chkDescripcion.Checked Then
                comando.CommandText = "select nombre_proveedor from proveedor where estado = '" & 1 & "' and descripcion_proveedor like '" & dato & "%' order by nombre_proveedor;"

            ElseIf dato <> "" And chkNombre.Checked Then
                comando.CommandText = "select nombre_proveedor from proveedor where estado = '" & 1 & "' and nombre_proveedor like '" & dato & "%' order by nombre_proveedor;"
    ...
    Private Sub ABMProveedores_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        Call Conectar()
        CargarList(txtBusqueda.Text.ToString)
        Call DeshabilitarCampos()
    ...
    Private Sub txtBusqueda_TextChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles txtBusqueda.TextChanged
        If chkDescripcion.Checked = False And chkNombre.Checked = False Then
            Exit Sub
        End If
